 ...
 */
public class BitNetParams extends AbstractBitcoinNetParams {
    ...
    private static BitNetParams instance;
    public static synchronized BitNetParams get() {
        if (instance == null) {
            instance = new BitNetParams();
        }
        return instance;
    }
