 ...
 */
public class LiteTestParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public LiteTestParams() {
        super();
        interval = INTERVAL;
        ...
        genesisBlock.setDifficultyTarget(0x1d018ea7L);//0x1d00ffffL);
        genesisBlock.setTime(1320884152L);//1231006505L);
        genesisBlock.setNonce(3562614017L);//2083236893);
        //genesisBlock.setMerkleRoot(new Sha256Hash("97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        id = ID_TESTNET;
        subsidyDecreaseBlockCount = 210000;//210000;
        ...
        dnsSeeds = new String[] {
                "testnet-seed.bitcoin.jonasschnelli.ch",         // Pieter Wuille
    ...
    private static LiteTestParams instance;
    public static synchronized LiteTestParams get() {
        if (instance == null) {
            instance = new LiteTestParams();
        }
        return instance;
    }
