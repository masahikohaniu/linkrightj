...
public class Main extends Application {
    ...
    //public static final String APP_NAME = "WalletTemplateTest";
    //bitcoin testnet<--
    public static NetworkParameters params = RightNetParams.get();
    public static final String APP_NAME = "WalletTemplateRight";

    
    //public static NetworkParameters params = LiteTestParams.get();
    //public static final String APP_NAME = "WalletTemplate";


    //public static final String APP_NAME = "WalletTemplateLiteTest";
