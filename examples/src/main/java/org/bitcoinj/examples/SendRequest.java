...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WalletAppKit kit = new WalletAppKit(params, new File("./wallettemplate/"), "WalletTemplateTest-test");
        ...
        Coin value = Coin.parseCoin("0.07");
        //Coin value = Coin.ZERO;

        // To which address you want to send the coins?
        // The Address class represents a Bitcoin address.
        LegacyAddress to = LegacyAddress.fromBase58(params, "2N8hwP1WmJrFF5QWABn38y63uYLhnJYJYTF");
